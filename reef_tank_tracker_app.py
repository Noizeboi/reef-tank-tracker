    ...
    with tabs[2]:
        ...
        with tabs[4]:
            ...
            if st.button("📄 Download PDF Report"):
                ...
                pdf.cell(200, 10, txt=f"Tank Report: {st.session_state.selected_tank}", ln=True)
                pdf.cell(200, 10, txt=f"Theme: {tank.get('theme', '')}", ln=True)
                pdf.cell(200, 10, txt=f"Livestock: {tank.get('livestock', '')}", ln=True)
                pdf.cell(200, 10, txt=f"Mode: {tank.get('mode', '')}", ln=True)
